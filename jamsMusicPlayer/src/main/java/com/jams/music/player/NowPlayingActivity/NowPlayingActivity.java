...
public class NowPlayingActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLyricsPlugin = new musiXmatchLyricsConnector(NowPlayingActivity.this);
    ...
    public void lyrics()
    {
        final String artist = mApp.getService().getCurrentSong().getArtist();
        final String track = mApp.getService().getCurrentSong().getTitle();

        mLyricsPlugin.setLoadingMessage(track, "Loading lyrics. Please wait...");

        try {
            mLyricsPlugin.startLyricsActivity(artist,track);
    ...
    public class PlaylistPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            Fragment fragment = new PlaylistPagerFragment(NowPlayingActivity.this);
